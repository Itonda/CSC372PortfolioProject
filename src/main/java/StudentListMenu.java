...
public class StudentListMenu {
    ...
    public void executeSortMenuSelection() throws InvalidStudentException {
        while (true) { // Loop until the user chooses to exit
            try {
                displaySortMenu(); // Display the sort menu
                getSelection(); // Get the user's selection
            ...
            try {
                ...
                switch (selection) { // Check the user's selection and execute the corresponding action
                    case 1: // Selection 1: Add Student
                        if (confirmAddStudent()) { // Confirm if the user wants to add a student
                    ...
                    case 4: // Selection 4: Sort Student List
                        executeSortMenuSelection(); // Call the method to execute sort menu selection
                        break;
